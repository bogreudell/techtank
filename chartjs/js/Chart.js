...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			tooltipFillColor: "rgba(250,250,250,.95)",
			...
			tooltipTitleFontStyle: "bolder",

			// String - Tooltip title font colour
			tooltipTitleFontColor: "#444",
			...
			if (ChartElements.length > 0){
				...
				if (this.datasets && this.datasets.length > 1) {
					...
					new Chart.MultiTooltip({
						...
						//legendColorStroke: this.options.multiTooltipKeyStroke,
